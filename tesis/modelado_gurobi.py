...
def ejecutarModeloGurobi(filePath):
    ...
    for e in E:
        for d in D:
            for o in O:
                for a in O:
                    if o != 0 and a !=0:
                        model.addConstr( (u[e,o,d] - u[e,a,d]) <= 999*(1-x[e,o,d,a])-1 + 999*(1- quicksum(x[e,a,d,i] for i in O)))
    ...
    #FO_ANS = quicksum(costosANS[o,d,h] * x[e,o,d,h] for e in E
    #                                                for o in O
    #                                                for h in H
    #                                                for d in D)  
    ...
    # Función Objetivo - Cumplimiento de órdenes prioritarias
    #FO_Prioridad = quicksum(prioridad[o] * x[e,o,d,h] for e in E
    #                                                  for o in O
    #                                                  for h in H
    #                                                  for d in D)
    ...
    model.setObjective(FO_Cumplimiento*(0.5) +
                       FO_Minmax*(0.5) )
